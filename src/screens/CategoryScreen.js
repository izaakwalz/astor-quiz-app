...
// quiz helper services
import GameHelper from '../services/Helper';

const CategoryScreen = ({route, navigation}) => {
  const {game} = route.params;

  //   const game = GameHelper.getActualGame(); // route.params or this
    ...
    <View style={styles.container}>
      <ImageBackground
        ...
        <View style={styles.headerContainer}>
          <Text style={styles.headerTitle}>Start Quiz?</Text>
        </View>
        ...
        <View style={styles.actionsContainer}>
          ...
          <TouchableOpacity
            onPress={() => {
              ...
              navigation.navigate('QuizScreen', {game: game});
            }}>
            <Image
