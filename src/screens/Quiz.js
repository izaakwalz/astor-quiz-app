...
export default class QuizScreen extends Component {
  ...
  _moveNext = () => {
    ...
    console.log(this.actualQuizOptio);
    ...
    if (GameHelper.isAnyQuizPending()) {
      ...
      this.props.navigation.navigate('GameResultsScreen');
    }
  };

  _checkValidAnswer = quizOption => {
    this.correctAnswer = GameHelper.checkValidAnswer(
      this.state.quiz,
      quizOption,
    );
  ...
  _renderQuizOption = ({item}) => (
    <QuizOptionItem quizOption={item} onPressItem={this._onPressOption} />
  );
